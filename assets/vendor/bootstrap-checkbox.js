        ...
        getTemplate: function() {
            ...
            var template = 
            	'<span class="button-checkbox bootstrap-checkbox">' +
            		'<button type="button" class="btn btn-file'+additionalButtonStyle+'">' +
            			((this.$element.data('label-prepend') && this.options.displayAsButton) ? labelPrepend : '')+
	                    '<span class="elusive '+this.options.checkedClass+'" style="display:none;"></span>' +
	                    '<span class="elusive '+this.options.uncheckedClass+'"></span>' +
	                    '<span class="elusive '+this.options.indeterminateClass+'" style="display:none;"></span>' +
