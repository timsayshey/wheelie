        ...
        plugin.method = {
            ...
            setupQuiz: function() {
                ...
                if (plugin.config.tryAgainText && plugin.config.tryAgainText !== '') {
                    $quizResultsCopy.before('<a class="btn btn-primary button ' + tryAgainClass + '" href="#">' + plugin.config.tryAgainText + '</a>');
                }
                ...
                for (i in questions) {
                    if (questions.hasOwnProperty(i)) {
                        ...
                        questionHTML.append('<h3 class="col-md-4">' + count + '. ' + question.q + '</h3>');
                        ...
                        var answerHTML = $('<div class="col-md-3"><h3>Pick a name!</h3><ul class="' + answersClass + '"></ul></div>');
                        ...
                        if (!plugin.config.disableResponseMessaging) {
                            ...
                            var responseHTML = $('<ul class="col-md-5 ' + responsesClass + '"></ul>');
                        ...
                        if (plugin.config.backButtonText && plugin.config.backButtonText !== '') {
                            questionHTML.append('<a href="#" class="btn btn-primary button ' + backToQuestionClass + '">' + plugin.config.backButtonText + '</a>');
                        }
                        ...
                        if (plugin.config.disableResponseMessaging || plugin.config.completionResponseMessaging) {
                            questionHTML.append('<a href="#" class="btn btn-primary button ' + nextQuestionClass + ' ' + checkAnswerClass + '">' + plugin.config.nextQuestionText + '</a>');
                        } else {
                            questionHTML.append('<a href="#" class="btn btn-primary button ' + nextQuestionClass + '">' + plugin.config.nextQuestionText + '</a>');
                            questionHTML.append('<a href="#" class="btn btn-primary button ' + checkAnswerClass + '">' + plugin.config.checkAnswerText + '</a>');
                        }
