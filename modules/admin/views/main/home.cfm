<cfoutput>
	...
	<div class="row-regular">		
		<a class="icon-btn-lg col-md-3" href='#urlFor(route="moduleAction", module="admin", controller="pages", action="new")#'>
			<span class="large-icon elusive icon-file-new-alt"></span>
			<strong>Add page</strong>
		</a>
		
		<a class="icon-btn-lg col-md-3" href='#urlFor(route="moduleAction", module="admin", controller="videos", action="new")#'>
			<span class="large-icon elusive icon-video-alt"></span>
			<strong>Add video</strong>
		</a>
		
		<a class="icon-btn-lg col-md-3" href='#urlFor(route="moduleAction", module="admin", controller="users", action="index")#'>
			<span class="large-icon elusive icon-group-alt"></span>
			<strong>Users</strong>
		</a>
		
		<a class="icon-btn-lg col-md-3" href='#urlFor(route="moduleAction", module="admin", controller="options", action="index")#'>
